...
<a href="<?php echo URLROOT ; ?>/events/index" class="btn btn-light"><i class="fa fa-backward"></i> Back</a>
  <div class="card card-body bg-light mt-5">
    <h2>Edit Event</h2>
    <p>Edit the event with this form</p>
    <form action="<?php echo URLROOT ; ?>/events/edit_event/<?php echo $data['event_id']; ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="input-group mt-5 mb-4">
        <div class="input-group-prepend">
          <span for="event_picture" class="input-group-text" id="inputGroupFileAddon01">Upload</span>
        </div>
